...
/*   Updated: 2024/12/01 18:10:55 by scambier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		read_number(int	*out, char *str, int *k, va_list va);
int		read_conversion_specification(t_conv_spec *out, char *str, va_list va);
